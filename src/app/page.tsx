    ...
    <div className="h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row min-h-0 relative">
        ...
        <div className="flex-1 relative">
          <Map users={filteredUsers} onUserClick={handleUserSelect} selectedUser={selectedUser} />
      ...
      {/* Quick Form Modal */}
      {showQuickForm && (
        <div className="fixed inset-0 bg-dark/80 backdrop-blur-sm z-[100] flex items-end sm:items-center justify-center" onClick={() => setShowQuickForm(false)}>
          <div onClick={e => e.stopPropagation()} className="animate-slide-up sm:animate-fade-in w-full sm:w-auto sm:max-w-md max-h-[90vh]">
